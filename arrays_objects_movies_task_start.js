...
//this doesnt work!! for (var currentMovie in movies) {
//   var uppercasedMovie = currentMovie.toUpperCase();
//   console.log(uppercasedMovie);
// };

// for (var key in movies) {
//   var movieName = movies[key];
//   console.log(movieName.title.toUpperCase());
// }
...
// for (var movie of movies) {
//   var upperTitle = movie.title.toUpperCase();
